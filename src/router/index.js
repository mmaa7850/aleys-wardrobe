  ...
  routes: [
...

    {
      ...
      children: [
        ...
        { path: "reports/order-settlement", name: "admin-reports-order-settlement", component: () => import("@/pages/admin/reports/OrderSettlementReport.vue") },
        ...
        { path: "tools/pdf-cropper",      name: "admin-tools-pdf-cropper",      component: () => import("@/pages/admin/tools/PdfCropper.vue"),             meta: { permission: "CanManageOrders" } },
