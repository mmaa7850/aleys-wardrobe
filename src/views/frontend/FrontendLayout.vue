...
const lineOaUrl = computed(() => siteConfig.get('line_oa_url'))
...
<template>
  <div class="fe-root">
    <!-- ── Announcement Bar ── -->
    <div v-if="siteConfig.announcement" class="fe-announce">
      {{ siteConfig.announcement }}
    </div>

    <!-- ── Navbar ── -->
    <nav :class="['fe-nav', { 'fe-nav--scrolled': isScrolled, 'fe-nav--offset': siteConfig.announcement }]">
